...
def upgrade():
    ...
    op.create_table('citationcontext',
                    sa.Column('id', sa.Integer(), server_default=sa.text("nextval('citationcontext_id_seq')"),
                              nullable=False),
    ...
    op.create_index('ionparenthetical_cited_opinion_id', 'citationcontext', ['cited_opinion_id'], unique=False)
    op.create_index('citationcontext_citing_opinion_id', 'citationcontext', ['citing_opinion_id'], unique=False)
