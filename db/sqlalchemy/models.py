...
class Citation(Base):
    ...
    id = Column(
        BigInteger,
        server_default=Sequence("citation_seq").next_value(),
        primary_key=True,
    )
    citing_opinion_id = Column(
        BigInteger, ForeignKey("opinion.resource_id"), index=True
    )
    ...
    def where_court(
        ...
        if citing_court and cited_court:
            citation_query = citation_query.filter(
...
class Cluster(Base):
    ...
    id = Column(
        BigInteger,
        server_default=Sequence("cluster_seq").next_value(),
        primary_key=True,
    )
...
class ClusterCitation(Base):
    ...
    id = Column(
        BigInteger,
        server_default=Sequence("clustercitation_seq").next_value(),
        primary_key=True,
    )
    citing_cluster_id = Column(
        BigInteger, ForeignKey("cluster.resource_id"), index=True
    )
...
class Opinion(Base):
    ...
    id = Column(
        BigInteger,
        server_default=Sequence("opinion_seq").next_value(),
        primary_key=True,
    )
    resource_id = Column(BigInteger, index=True, unique=True)
    ...
    out_citations = relationship(
        "Citation",
        primaryjoin="Opinion.resource_id == Citation.citing_opinion_id",
        backref="citing_opinion",
    )
    in_citations = relationship(
        "Citation",
        primaryjoin="Opinion.resource_id == Citation.cited_opinion_id",
    ...
    citation_contexts = relationship(
        "CitationContext",
...
class OpinionParenthetical(Base):
    ...
    id = Column(
        Integer,
        server_default=Sequence("opinionparenthetical_id_seq").next_value(),
        primary_key=True,
    )
    citing_opinion_id = Column(
...
class CitationContext(Base):
    ...
    id = Column(
        Integer,
        server_default=Sequence("citationcontext_id_seq").next_value(),
        primary_key=True,
    )
    citing_opinion_id = Column(
        Integer, ForeignKey("opinion.resource_id"), index=True, nullable=False
...
class Similarity(Base):
    ...
    id = Column(
        BigInteger,
        server_default=Sequence("similarity_seq").next_value(),
        primary_key=True,
    )
