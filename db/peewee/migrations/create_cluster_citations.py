...
if __name__ == "__main__":
    ...
    existing_citations_query = (
        Citation.select(
            Citation, CitingOpinion, CitedOpinion, CitingCluster, CitedCluster
        )
    ...
    cluster_citation_dict = (
        {}
    )  # Key: tuple of citing cluster ID, cited cluster ID; value: ClusterCitation model
    i = 0
    for citation in existing_citations_query:
        ...
        citing_cluster, cited_cluster = (
            citation.citing_opinion.cluster,
            citation.cited_opinion.cluster,
        )
        ...
        cluster_citation_dict[identifier_tuple] = ClusterCitation(
