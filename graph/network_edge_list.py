...
class NetworkEdgeList:
    ...
    def __populate_edge_list_and_metadata(self, in_neighbor_dict: Dict[int, List[int]], out_neighbor_dict: Dict[int, List[int]]):
        self.node_metadata = {}
        ...
        for opinion_id in ids:
            ...
            in_neighbors, out_neighbors = in_neighbor_dict[opinion_id], out_neighbor_dict[opinion_id]
